...
<footer class="page-footer-bottom">
    <div class="grid-row">
        ...
        <nav class="secondary-nav">
            <ul>
                             <li>{!! HTML::link('/', trans('navs.home')) !!}</li><!--
							--><li>{!! HTML::link('/category', trans('innovate.menus.category')) !!}</li><!--
							--><li>{!! HTML::link('/product', trans('innovate.menus.product')) !!}</li><!--
							--><li>{!! HTML::link('/product/trend', trans('innovate.menus.trend_products')) !!}</li>
